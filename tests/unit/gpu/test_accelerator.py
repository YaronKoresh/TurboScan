...
class TestGPUAccelerator:
    ...
    def test_init_no_gpu(self) -> None:
    ...
    def test_init_with_gpu(self, mock_torch) -> None:
    ...
    @patch("turboscan.gpu.accelerator.GPU_COUNT", 4)
    @patch("turboscan.gpu.accelerator.torch")
    def test_stream_context_manager(self, mock_torch) -> None:
    ...
    def test_batch_hash_cpu(self) -> None:
