...
class BloomFilter:
    ...
    def _hashes(self, item: str) -> List[int]:
        ...
        h1 = int.from_bytes(hashlib.blake2b(item_bytes, digest_size=16).digest(), 'big')
        h2 = int.from_bytes(hashlib.blake2b(item_bytes, digest_size=16, key=b'salt').digest(), 'big')
